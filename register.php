...
function try_register() {
  ...
  if (!preg_match('/^\w{3,20}$/', $_POST['login'])) { $errors[] = 'Логин должен состоять только из латинских букв и цифр и должен быть не короче 3 и не длиньше 20 символов'; }
  if (!preg_match('/^\w{6,20}$/', $_POST['password'])) { $errors[] = 'Пароль должен состоять только из латинских букв и цифр и должен быть не короче 3 и не длиньше 20 символов'; }
